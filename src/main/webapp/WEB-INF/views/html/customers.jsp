														...
														<div class="dropdown">
															...
															<ul class="dropdown-menu"
																...
																<li><a class="dropdown-item edit-link"
																	href="/admin/customers1/edit/${item.maKhachHang}"
																	data-id="${item.maKhachHang}"
																	data-name="${item.tenKhachHang}"
																	data-email="${item.emailKH}"
																	data-matkhau="${item.matKhauKH}"
																	data-sodienthoai="${item.soDienThoaiKH}"
																	data-diachi="${item.diaChiKH}" data-bs-toggle="modal"
																	data-bs-target="#editModal">Edit</a></li>
																<li><a class="dropdown-item"
																	href="/admin/customers1/delete/${item.maKhachHang}">Delete</a></li>
															</ul>
														</div>
													</td>
												</tr>
											...
											<div class="modal-body">
												<form:form modelAttribute="item">
													<div class="form-group">
														...
														<form:hidden path="maKhachHang" class="form-control"
															id="maKhachHang" />
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<form:input path="emailKH" class="form-control"
															id="emailKH" />
													</div>
													<div class="form-group">
														<label for="matKhauKH">Mật khẩu:</label>
														<form:input path="matKhauKH" class="form-control"
															id="matKhauKH" />
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<form:input path="diaChiKH" class="form-control"
															id="diaChiKH" />
													</div>
													<div class="mb-3">
														<button formaction="/admin/customers1/save"
															class="btn btn-primary">Lưu</button>
														<button formaction="/admin/customers1/update"
															class="btn btn-primary">Sửa</button>
														<button
															formaction="/admin/customers1/delete/${item.maKhachHang}"
															class="btn btn-danger">Xóa</button>
														<a href="/admin/customers1/index"
															class="btn btn-secondary">Trở lại</a>
													</div>
												</form:form>
											</div>
										</div>
	...
	<script>
		$(document).ready(function() {
			...
			$('.edit-link').on('click', function(event) {
				...
				var tenKhachHang = $(this).data('name');
				var emailKH = $(this).data('email');
				var matKhauKH = $(this).data('matkhau');
				var soDienThoaiKH = $(this).data('sodienthoai');
				var diaChiKH = $(this).data('diachi');

				// Điền dữ liệu vào các trường trong modal
				$('#tenKhachHang').val(tenKhachHang);
				$('#emailKH').val(emailKH);
				$('#matKhauKH').val(matKhauKH);
				$('#soDienThoaiKH').val(soDienThoaiKH);
