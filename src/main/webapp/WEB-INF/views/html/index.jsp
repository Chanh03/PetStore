		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					<!-- Dashboard -->
					<li class="menu-item active"><a href="/admin/index"
						class="menu-link"> <i
												...
												<div class="text-center">
													<div class="dropdown">
														<button
															...
															data-bs-toggle="dropdown" aria-haspopup="true"
															aria-expanded="false">2022</button>
														<div class="dropdown-menu dropdown-menu-end"
										...
										<div class="card">
											<div class="card-body">
												<div
													...
													<div class="avatar flex-shrink-0">
														<img
															src="${pageContext.request.contextPath}/assets/img/icons/unicons/paypal.png"
															alt="Credit Card" class="rounded" />
													</div>
													<div class="dropdown">
										...
										<div class="card">
											<div class="card-body">
												<div
													...
													<div class="avatar flex-shrink-0">
														<img
															src="${pageContext.request.contextPath}/assets/img/icons/unicons/cc-primary.png"
															alt="Credit Card" class="rounded" />
													</div>
													<div class="dropdown">
										...
										<tbody>
											<c:forEach var="order" items="${ordersInfo}">
												<tr>
													...
													<td>${order[4]}</td>
													<td>${order[5]}</td>
													<td><fmt:formatNumber value="${order[6]}"
															type="currency" currencyCode="VND" /></td>
													<td><fmt:formatNumber value="${order[7]}"
															type="currency" currencyCode="VND" /></td>
													<td>
														<button
										...
										<div class="tab-content p-0">
											<div class="tab-pane fade show active"
												...
												<div class="d-flex p-4 pt-3">
													<div class="avatar flex-shrink-0 me-3">
														<img
															src="${pageContext.request.contextPath}/assets/img/icons/unicons/wallet.png"
															alt="User" />
													</div>
													<div>
									...
									<div class="card-body">
										<ul class="p-0 m-0">
											...
											<li class="d-flex mb-4 pb-1">
												<div class="avatar flex-shrink-0 me-3">
													<img
														src="${pageContext.request.contextPath}/assets/img/icons/unicons/chart.png"
														alt="User" class="rounded" />
												</div>
												<div
													class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											...
											<li class="d-flex mb-4 pb-1">
												<div class="avatar flex-shrink-0 me-3">
													<img
														src="${pageContext.request.contextPath}/assets/img/icons/unicons/cc-success.png"
														alt="User" class="rounded" />
												</div>
												<div
													class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
